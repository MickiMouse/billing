            ...
            >
                ...
                >
                    <v-card class="elevation-12" v-if="!submitted && !stage2">
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="primary" @click.prevent="submitLoginForm">Submit</v-btn>
                        </v-card-actions>
                    ...
                    <v-card class="elevation-12" v-else>
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="primary" @click.prevent="submitLoginFormStage2">Submit</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-flex>
            </v-layout>
        ...
        methods: {
            ...
            submitLoginFormStage2() {
                if (!this.$refs.form2.validate()) {
                    ...
                    if (this.$route.params.token) {
                        axios.put(`${this.$hostname}/api/password/${this.$route.params.token}/`, {password:this.password, password2:this.repeatedPassword})
                            .then((response) => {
                                if (response.status === 200) {
